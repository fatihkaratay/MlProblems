...
def get_user_interaction_counts(search_interaction_df):
    ...
    user_month_counts = get_df_counts_from_date_by_user(search_interaction_df, latest_date, 30)
    user_week_counts = get_df_counts_from_date_by_user(search_interaction_df, latest_date, 7)
    user_day_counts = get_df_counts_from_date_by_user(search_interaction_df, latest_date, 1)
...
def get_df_counts_from_date_by_user(df, end_date, days_delta):
